...
class EvenArrayIndexTest {
    ...
    void testEvenIndex(int[] inputArray, int resultIndex) {
        ...
        assertEquals(resultIndex, evenArrayIndex.getEvenIndex(inputArray));
        assertEquals(resultIndex, evenArrayIndex.getEvenIndexUsingStream(inputArray));
        assertEquals(resultIndex, evenArrayIndex.getEvenIndexOptimized(inputArray));
    }
}
